  ...
  <div class="terminal overflow-hidden relative group">
    ...
    <div class="p-6 md:p-8 bg-obsidian/50 relative z-10 flex flex-col items-center">
      <div class="w-full max-w-[500px]">
        ...
        <!-- Drum Kit UI Layout -->
        <div class="relative w-full aspect-video bg-obsidian/30 rounded-xl border border-gray-800/50 p-4 mb-4">
          
          <!-- Cymbals Row -->
          <div class="flex justify-between px-8 mb-4">
             <button @mousedown="() => { initAudio(); playSound('ride'); }" @touchstart.prevent="() => { initAudio(); playSound('ride'); }"
            ...
            <div class="flex gap-4">
              <button @mousedown="() => { initAudio(); playSound('openhat'); }" @touchstart.prevent="() => { initAudio(); playSound('openhat'); }"
              ...
              <button @mousedown="() => { initAudio(); playSound('hihat'); }" @touchstart.prevent="() => { initAudio(); playSound('hihat'); }"
                class="w-16 h-16 rounded-full border-4 border-accent/30 bg-accent/10 flex items-center justify-center transition-all active:scale-95"
          ...
          <div class="flex justify-center gap-6 mb-4">
            <button @mousedown="() => { initAudio(); playSound('tom', 1.5); }" @touchstart.prevent="() => { initAudio(); playSound('tom', 1.5); }"
            ...
            <button @mousedown="() => { initAudio(); playSound('tom', 0.8); }" @touchstart.prevent="() => { initAudio(); playSound('tom', 0.8); }"
          ...
          <div class="flex flex-col items-center">
            <div class="flex gap-12 items-end">
              <button @mousedown="() => { initAudio(); playSound('snare'); }" @touchstart.prevent="() => { initAudio(); playSound('snare'); }"
              ...
              <button @mousedown="() => { initAudio(); playSound('kick'); }" @touchstart.prevent="() => { initAudio(); playSound('kick'); }"
